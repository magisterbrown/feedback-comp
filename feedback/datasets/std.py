...
class EssayDs(Dataset):
    def __init__(self, df, tokenizer, targets, max_size=512, padding=True):
        self.df = df
    ...
    def __getitem__(self, idx):
        ...
        tokens = self.tokenizer(text,max_length=self.max_size,padding=self.padding,truncation=True) 
